...
import listener.ProfileDeleteListener;
import models.User;
...
/**
 *  This class include all buttons on the top of profile frame.
 */
...
//                    URL resource = this.getClass().getResource(user.getPhotoURL());
        ...
        try {
            read = ImageIO.read(new URL("https://sf1-ttcdn-tos.pstatp.com/img/user-avatar" +
                    "/97cf4f165a904ca4b119d2de407f9e1e~300x300.image"));
        ...
        jButton.setBounds(300,5,80,20);

        JButton delete = new JButton("delete");
        delete.setBounds(300,25,80,20);
        ...
        username.setBounds(220,20,150,20);
        ...
        favorite.setBounds(220,80,150,20);
